...
function Footer() {
  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    CarWale helps you buy the right car at the right price. Explore the latest car models, read expert reviews, compare features, and get the best deals — all in one place.
    </p>
    ...
    <div>
    <h5 className='flex justify-center mt-5 text-gray-700'>Developed By : Yug Punjabi </h5>
    </div>
  </div>
</footer>
  )
